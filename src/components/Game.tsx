...
import { AiFillApple, AiFillWindows, AiOutlineLike, AiOutlinePlus, AiOutlineShopping } from 'react-icons/ai'
  ...
  return (
    <section className='mt-10 flex gap-2'>
            <article className='relative'>
              <Image src={"/banners/witcher3.jpg?v=123"} width={720} height={720} alt="Banner do jogo The Witcher 3" className='rounded-3xl' />
            ...
            <div className='flex flex-col flex-1 gap-2'>
              ...
              <article className='grid grid-cols-2 w-full flex-1 gap-2'>
                <div className='relative rounded-xl overflow-hidden'>
                  <Image src="/banners/god-of-war.jpg" fill alt="Banner do jogo God of War" />
                </div>
                <div className='relative rounded-xl overflow-hidden'>
                  <Image src="/banners/god-of-war.jpg" fill alt="Banner do jogo God of War" />
                  <div className='absolute w-full h-full bg-black/75 flex flex-col items-center justify-center'>
                    ...
                    <span className='text-sm font-light text-white/60'>more photos</span>
                  </div>
                </div>
              </article>
            </div>
